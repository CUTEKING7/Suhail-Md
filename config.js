...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://i.imgur.com/KYNrRRW.jpeg" ; // SET LOGO FOR IMAGE 
...
module.exports = {
  ...
  caption : process.env.CAPTION || "RizwaN 106" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴜʜᴀɪʟ²²¹-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@rizwantechinfo106"),
 
  author : process.env.PACK_AUTHER|| "`RizwaN 106`",
  ...
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : "RizwaN",
